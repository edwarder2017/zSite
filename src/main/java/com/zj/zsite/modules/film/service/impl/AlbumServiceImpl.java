package com.zj.zsite.modules.film.service.impl;
...
import com.zj.zsite.modules.film.dao.AlbumDao;
import com.zj.zsite.modules.film.dao.FilmDao;
import com.zj.zsite.modules.film.entity.Album;
import com.zj.zsite.modules.film.entity.Film;
import com.zj.zsite.modules.film.service.AlbumService;
...
public class AlbumServiceImpl implements AlbumService {
	...
	public String savePicToDisk(MultipartFile file) throws Exception{
		if(!file.isEmpty()){
			...
			//存储图片的物理路径
			String storePath = "D:\\project\\upload\\temp\\";
			//新的图片名称
